package md58fe150a9bad02b99177d9bdcb868bfa0;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.Geolocator.GeolocationContinuousListener, Plugin.Geolocator, Version=4.0.2.0, Culture=neutral, PublicKeyToken=null", GeolocationContinuousListener.class, __md_methods);
	}
	...
	public GeolocationContinuousListener ()
	{
		...
		if (getClass () == GeolocationContinuousListener.class)
			mono.android.TypeManager.Activate ("Plugin.Geolocator.GeolocationContinuousListener, Plugin.Geolocator, Version=4.0.2.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
