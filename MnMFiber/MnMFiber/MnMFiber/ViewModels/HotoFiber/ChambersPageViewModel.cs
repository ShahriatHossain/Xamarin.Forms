...
{
    public class ChambersPageViewModel : BindableBase, IBaseInterface
    {
        INavigationService _navigationService;
        IHotoFiberService _hotoFiberRepository;

        public ChambersPageViewModel(INavigationService navigationService, IHotoFiberService hotoFiberRepository)
        {
        ...
        private async void TakePhotoAsync()
        {
            ...
            HotoFiberSession.Current.MediaFiles.Media2 = file;
            HotoFiberSession.Current.SetMediaFiles(HotoFiberSession.Current.MediaFiles);

            MediaFileFlags.IsMedia2Uploaded = true;
        }
    }
}
