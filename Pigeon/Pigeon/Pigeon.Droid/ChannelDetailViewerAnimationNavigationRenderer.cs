...
[assembly: ExportRenderer(typeof(NavigationPage), typeof(ChannelDetailViewerAnimationNavigationRenderer))]
namespace Pigeon.Droid
{
    public class ChannelDetailViewerAnimationNavigationRenderer : NavigationPageRenderer, Android.Views.View.IOnClickListener
    {
        ...
        static ChannelDetailViewerAnimationNavigationRenderer()
        {
        ...
        public void OnClick(Android.Views.View v)
        {
            ...
            var curPage = Element.CurrentPage as ChannelDetailViewer;
            if (curPage == null)
            {
                Element.PopAsync();
            }
