...
[assembly: ExportRenderer(typeof(NavigationPage), typeof(InstituteDiscoverPageAnimationNavigationRenderer))]
namespace Pigeon.Droid
{
     public class InstituteDiscoverPageAnimationNavigationRenderer : NavigationPageRenderer, Android.Views.View.IOnClickListener
    {
        ...
        static InstituteDiscoverPageAnimationNavigationRenderer()
        {
        ...
        public void OnClick(Android.Views.View v)
        {
            ...
            var curPage = Element.CurrentPage as InstituteDiscoverPage;
            if (curPage == null)
            {
                Element.PopAsync();
            }
